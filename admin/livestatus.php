...
if (isset($_SESSION['username'])=="admin") {    
   ...
   // include_once 'livesensorupdates.php';
?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <!--    <li>
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active"><a href="livestatus.php"><span class="xn-text">Signal Status</span></a></li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Signal Status</li>
                </ul>
                <!-- END BREADCRUMB --> 
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Live status of all signal</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                /*        if($this_result=="failed"){
                            ...
                            if(isset($page_error)){
                                ...
                                printf("<br/><b><center style=\"color:#000;\">$msg</center></b>");
                                echo "<div class=\"row\">
                                        <div class=\"col-md-12\">                                        
                                            <div class=\"error-container\">
                                                <div class=\"error-code\">404</div>
                                                <div class=\"error-text\">page not found</div>
                                                <div class=\"error-subtext\">$msg</div>
                                            </div>
                                        </div>
                                    </div>";
                            }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Signal Status Details</h3>
                                </div>
                                <div class="panel-body">
                                	<table class="table table-hover" id="main_content_table">
                                    </table>
                                    <?php
//                                        //include_once 'conn.php';
    ...
    <!--    <script type="text/javascript" src="js/settings.js"></script>-->
        ...
        <script type="text/javascript">
			$(document).ready(function(){
				$('#main_content_table').append("<thead><tr><td>SrNo.</td><td>ID </td><td>Signal Id</td><td>Density1</td><td>Density2</td><td>Density3</td><td>Density4</td><td>Sensor Fault</td></tr></thead>");
				$.ajax({
					method: "POST",
					contentType: "application/json; charset=utf-8",
					dataType: "json",
					url: "livestatusdata.php",
					}).done(function( msg ) {
						$.each(msg.data,function(i,v){
							$('#main_content_table').append("<tbody><tr class='even pointer'><td>"+ parseInt(i+1) +"</td><td>"+ v["id"] +"</td><td>"+ v["signal_id"] +"</td><td>"+ v["density1"] +"</td><td>"+ v["density2"] +"</td><td>"+ v["density3"] +"</td><td>"+ v["density4"] +"</td><td>"+ v["sensor_fault"] +"</td></tbody>");	
						});
					});
