...
if (isset($_SESSION['username'])=="admin") {
    ...
    if(isset($_GET['ID'])||!empty($_GET['ID']))
    {
        ...
        $ID=$_GET['ID'];
        $sqlQuery1=mysqli_query($conn,"SELECT * FROM sensor_mst WHERE id='$ID'");
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <form role="form" class="form-horizontal" action="seupdatedata.php?ID=<?php echo $ID?>" method="post">  
                                    ...
                                    <!-- START VALIDATIONENGINE PLUGIN -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">                                                                                            
                                                    <select class="form-control select" id="Signalid" name="SignalId">
                                                    <option><?php echo $row1['signal_id'];?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="sensorid" name="SensorId" value="<?php echo $row1['sensor_id'];?>" class="form-control" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="sensortype" name="SensorType" value="<?php echo $row1['sensor_type'];?>" class="form-control"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <?php
                                    //include_once 'conn.php';
                                    $query1=mysqli_query($conn,"SELECT * FROM sensor_mst");
                                    echo"
