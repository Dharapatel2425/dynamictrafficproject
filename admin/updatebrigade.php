...
if (isset($_SESSION['username'])=="admin") {
    ...
    {
        $ID=$_GET['ID'];
        $sqlQuery1=mysqli_query($conn,"SELECT * FROM traffic_brigade WHERE id='$ID'");
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <form class="form-horizontal" action="bupdatedata.php" method="post"> 
                                    ...
                                    <!-- START VALIDATIONENGINE PLUGIN -->  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="name" name="UName" value="<?php echo $row1['name'];?>" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="email" id="email" name="EmailId" value="<?php echo $row1['email'];?>" class="form-control" id="password"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" id="phonenumber" name="Phone" value="<?php echo $row1['phonenumber'];?>" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea rows="3" id="address" name="Address" class="form-control"><?php echo $row1['address'];?></textarea>
                                                  <!--   <span class="help-block">Required, min size = 5, max size = 30</span>-->
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="city" name="City" value="<?php echo $row1['city'];?>" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" id="pincode" value="<?php echo $row1['pincode'];?>" name="Pincode" class="form-control"/>
