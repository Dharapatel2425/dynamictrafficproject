...
if (isset($_SESSION['username'])=="admin") {
    ...
    if (isset($_POST['submit'])) {
       // $ID = mysqli_real_escape_string($conn, $_POST['ID']);
        ...
        $sqlQuery="SELECT * FROM signal_mst WHERE signal_id='$signal_id' OR area='$area' OR (latitude=$latitude AND longitude=$longitude)" ;
        
        $result=mysqli_query($conn,$sqlQuery);
        if(mysqli_num_rows($result) == 0)
        {
            $result1=mysqli_query($conn, "INSERT INTO signal_mst(signal_id,area,latitude,longitude,signal_status) VALUES('" . $signal_id . "', '" . $area . "' , " .$latitude . "," . $longitude.", '" . $signal_status . "')");
            if($result1) {
            ...
            $msg="Signal id or signal at location Already Exist!";
            //echo $msg;
        }
                                ...
                                <form role="form" class="form-horizontal" action="" method="post">  
                                    ...
                                    <!-- START VALIDATIONENGINE PLUGIN -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="signalid" name="SignalId" placeholder="Enter Signal Id" required="required" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea rows="2" id="area" name="Area" placeholder="Enter Area" required="required" class="form-control"></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="latitude" name="Latitude" placeholder="Latitude" required="required" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="longitude" name="Longitude" placeholder="Longitude" required="required" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control select" id="signalstatus" name="SignalStatus" placeholder="Signal Status">
                                                        <option value="ON">Select</option>
                                                        <option>ON</option>
                                                        <option>OFF</option>
                                                    </select>
                                            
                                                  <!--  <input type="text" id="signalstatus" name="SignalStatus" placeholder="Signal Status" required="required"
                                                    class="form-control"/>-->
                                                  <!--   <span class="help-block">Required, integer, min value = 18, max = 120</span>-->
                                                </div>                        
                                            </div>
