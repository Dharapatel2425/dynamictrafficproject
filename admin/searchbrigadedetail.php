        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active"><a href="searchbrigadedetail.php"><span class="fa fa-search"></span> Search Details</a></li>
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Search Details</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                                ...
                                <form class="form-horizontal" action="" method="post"> 
                                    ...
                                    <!-- START VALIDATIONENGINE PLUGIN -->                           
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Search Area :</label>
                                                <div class="col-md-6">
                                                    <select class="form-control select" id="area" name="Area" placeholder="Select Area ">
                                                        <option value="">Select Area</option>
                                                        <?php
                                                            //include_once 'conn.php';
                                                            $query = "SELECT DISTINCT area FROM traffic_brigade UNION SELECT DISTINCT area FROM signal_mst ORDER By area";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                <select class="form-control select" id="name" name="UName" placeholder="Select Area ">
                                                    <option value="">Select</option>
                                                    <?php        
                                                        //include_once 'conn.php';
                                                        $query2=mysqli_query($conn,"SELECT name FROM traffic_brigade ORDER By name");
                                                        while($row_name=mysqli_fetch_assoc($query2))
                                                        {
                                                            ?>
                                        ...
                                        <!--    <div class="form-group">
                                                <label class="col-md-3 control-label">Search Name:</label>
                                                <div class="col-md-6">
                                                    <input type="text" id="name" name="UName" placeholder="Enter Name" class="form-control"/>
                                    ...
                                    <div class="panel-footer">
                                        ...
                                        <button class="btn btn-primary pull-right" name="submit" id="submit">Search</button>
                                    </div>
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit']))
                        {
                            $area = $_POST['Area'];
                            $name = $_POST['UName'];
                            //echo " ".$_POST['Area']." ".$_POST['UName'];
                            $sqlQuery = "SELECT * FROM traffic_brigade WHERE area='$area' OR name='$name'";
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <!--<div class="panel-body">-->
                                    ...
                                    <div class="row">
                                    <?php
                                        $num_user=mysqli_num_rows($result1);
                                        if($num_user==0)
                                        {
                                            ?>
                                            <div class="col-md-3">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title"><?php echo "There is no any Search Result"?></h3>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-body profile">
                                                            <div class="profile-image">
                                                                <img src="assets/images/users/no-image.jpg" alt="<?php echo $row['name']; ?> Profile Image"/>
                                                            </div>
                                                            <div class="profile-data">
                                                                <!-- echo "<tr class='even pointer'><td>".$ID++ ."</td>";
                                                                echo "<td>".$row['id']."</td>";-->
                                                                <div class="profile-data-name"><?php echo $row['name']; ?></div>
                                                                <div class="profile-data-title"><?php echo $row['city']; ?></div>
                                                            </div>
                                                            <div class="profile-controls">
                                                        ...
                                                        <div class="panel-body">                                    
                                                            <div class="contact-info">
                                                                <p><small>Mobile</small><br/><?php echo $row['phonenumber']; ?></p>
                                                                <p><small>Email</small><br/><?php echo $row['email']; ?></p>
                                                                <p><small>Address</small><br/><?php echo $row['address']; ?></p>
                                                                <p><small>SignalId</small><br/><?php echo $row['signal_id']; ?></p>
                                                                <p><small>City</small><br/><?php echo $row['city']; ?></p>
                                                                <p><small>Area</small><br/><?php echo $row['area']; ?></p>
                                                                <p><small>pincode</small><br/><?php echo $row['pincode']; ?></p>                                  
                                                            </div>
                                                        </div>                                
                                                    </div>
                                                    <!-- END CONTACT ITEM -->
