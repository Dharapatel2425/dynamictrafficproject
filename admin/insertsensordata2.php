...
if($this_result == "succeeded")
{
	...
	$d1=$json3["D1"]*11; $d2=$json3["D2"]*11; $d3=$json3["D3"]*11; $d4=$json3["D4"]*11; $fault=$json3["F"];
	
	$sqlQuery = "INSERT INTO graph_status(signal_id,date1,time1,density1,density2,density3,density4,sensor_fault) VALUES ('S2','$date','$time', $d1,$d2,$d3,$d4,$fault)";
