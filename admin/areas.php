        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Area</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                                    ...
                                    <!-- START VALIDATIONENGINE PLUGIN -->                           
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">                                                                                            
                                                    ...
                                                    <?php
                                                        //include_once 'conn.php';
                                                        $query=mysqli_query($conn,"SELECT * FROM signal_mst ORDER BY area");
                                                        while($row_area=mysqli_fetch_array($query))
                                                        {
                                                            echo"<option>".$row_area['area']."</option>";
                    ...
                    <?php
                        ...
                        {
                            $sqlQuery = "SELECT * FROM signal_mst WHERE area='".$_POST['Area']."'";
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <?php      
                                        ...
                                        while($row1=mysqli_fetch_array($result1))
                                        {
                                            ...
                                            echo "<td>".$row1['id']."</td>";
                                            echo "<td>".$row1['signal_id']."</td>";
                                            echo "<td>".$row1['density1']."</td>";
                                            echo "<td>".$row1['density2']."</td>";
                                            echo "<td>".$row1['density3']."</td>";
                                            echo "<td>".$row1['density4']."</td>";
                                            echo "<td>".$row1['sensor_fault']."</td>";
                                            echo "</tr></tbody>";   
                                        }
                                        ?>
                                        </table>
